...
//     var toggleVisibility = function(cbShow, cbHide, element){
//         document.addEventListener('click', function(){
//             for(var i = 0; i < state.itineraries.length; i++){
//                 if(window.location.href.indexOf(state.itineraries[i]) !== -1){
//                     cbShow(element);
//                     break;
//                 }
//                 if(window.location.href.indexOf(state.itineraries[i]) === -1){
...
//     var addPeopleWatchinComponent = function(){
//         if(!document.querySelector('ge_people-watching')){
